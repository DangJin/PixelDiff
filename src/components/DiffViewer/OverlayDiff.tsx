  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        {/* Opacity Slider - 底部（ZoomToolbar 上方） */}
        <div className="absolute bottom-20 left-1/2 -translate-x-1/2 z-20 flex items-center gap-3 bg-md-surface/95 backdrop-blur-md rounded-full px-4 py-2 shadow-md-2 border border-md-outline-variant">
